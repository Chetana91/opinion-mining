...
datamatrix_svm= create_matrix(data_frame[,1], language="english", minDocFreq=1, minWordLength=1, maxWordLength = 7,
                              removeNumbers=TRUE, removePunctuation=FALSE, removeSparseTerms=0, removeStopwords=TRUE, 
